// services.js - COMPLETE FIXED VERSION
...
// NEW: Dashboard-specific API endpoints for 18 sub-roles
export const dashboardAPI = {
  ...
  getFinancialAdvisorDashboard: () => 
    apiCall(djangoClient.get, '/api/v1/dashboard/agent/financial/'),
  
  getTechnicalAdvisorDashboard: () => 
    apiCall(djangoClient.get, '/api/v1/dashboard/agent/technical/'),
  
  getLegalSpecialistDashboard: () => 
    apiCall(djangoClient.get, '/api/v1/dashboard/agent/legal/'),
  
  getMarketAnalystDashboard: () => 
    apiCall(djangoClient.get, '/api/v1/dashboard/agent/market/'),
...
// In services.js - UPDATE the cartAPI endpoints:
